...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Field Cari'), 'Kasir Aja')

Mobile.scrollToText('Kasir Aja', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('KasirAja/Pengguna Page/Card Pengguna First'), 0)

Mobile.clearText(findTestObject('KasirAja/Pengguna Page/Detail Pengguna/Edit Field Email'), 0)

Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Detail Pengguna/Edit Field Email'), 'kasirubah@sampurasun.com')
