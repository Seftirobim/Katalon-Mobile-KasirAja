...
Mobile.verifyElementVisible(findTestObject('KasirAja/Kasir/Nav Title'), 5)
...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Nama'), 'kasir 4')

Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Email'), 'kasir4@sampurasun.com')

Mobile.tap(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Button Simpan'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementVisible(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 0, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 'password wajib diisi', 
