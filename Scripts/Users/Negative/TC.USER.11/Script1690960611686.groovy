...
Mobile.verifyElementVisible(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 5, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 'email wajib diisi', FailureHandling.CONTINUE_ON_FAILURE)
