...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Email'), 'kasir4@')
...
Mobile.verifyElementVisible(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 2, FailureHandling.CONTINUE_ON_FAILURE)

Mobile.verifyElementText(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), '"email" harus menggunakan email yang valid', 
