...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Field Cari'), 'Kasir 2')

Mobile.scrollToText('Kasir 2', FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('KasirAja/Pengguna Page/Card Pengguna First'), 0)

Mobile.tap(findTestObject('KasirAja/Pengguna Page/Detail Pengguna/Button hapus detail'), 0)

Mobile.tap(findTestObject('KasirAja/Pengguna Page/Detail Pengguna/Button Modal Ya'), 0)

// Toast Handler
KeywordLogger log = new KeywordLogger()
AppiumDriver<?> driver = MobileDriverFactory.getDriver()

def toast = driver.findElementByXPath('//android.widget.Toast[@text=\'Pengguna dihapus\']').getText()
