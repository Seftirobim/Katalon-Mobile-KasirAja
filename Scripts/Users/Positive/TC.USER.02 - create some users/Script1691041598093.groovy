...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Nama'), 'Kasir 1')

Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Email'), 'kasir1@sampurasun.com')
...
Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Nama'), 'Kasir 2')

Mobile.sendKeys(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Field Email'), 'kasir2@sampurasun.com')
