...
Mobile.verifyElementVisible(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 0)

Mobile.verifyElementText(findTestObject('KasirAja/Pengguna Page/Buat Pengguna/Alert Error Msg'), 'nama wajib diisi')
