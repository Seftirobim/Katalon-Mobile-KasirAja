...
Mobile.sendKeys(findTestObject('KasirAja/Login Page/emailLogin'), 'kasirubah@sampurasun.com')

Mobile.sendKeys(findTestObject('KasirAja/Login Page/passLogin'), 'rampesubah123')
